...
export const uiCopyCatalog = {
  ko: {
    ...
    status: {
      ...
      descriptions: {
        waiting: "결정 또는 착수가 필요한 작업입니다.",
        todo: "바로 시작할 수 있는 작업입니다.",
        in_progress: "현재 진행 중인 작업입니다.",
  ...
  en: {
    ...
    status: {
      ...
      descriptions: {
        waiting: "Tasks waiting for a decision or kickoff.",
        todo: "Ready to start next.",
        in_progress: "Work that is actively moving.",
