...
import { confirmKnowledgeImportPreview } from "@/use-cases/admin/knowledge-import-preview-service";
...
export async function POST(
  ...
  try {
    ...
    const data = await confirmKnowledgeImportPreview({ projectId: projectContext.project.id, previewId }, user);
