...
Verify/Time: Vercel project/deployment showed `dpl_6EzQmCbdjRdMw1J3ghGBzFNbU4UY` as `READY`; latest PR head `3199f00` checks and Vercel status were success; Preview `/login` returned `200` with CSP, HSTS, nosniff, frame, referrer, permissions, and noindex headers on 2026-04-24.
