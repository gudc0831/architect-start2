...
assert.match(serviceSource, /createMany/);
assert.match(serviceSource, /skipDuplicates: true/);
assert.match(serviceSource, /for update/i);
assert.match(serviceSource, /TaskCellDocumentConcurrentUpdateError/);
assert.match(serviceSource, /updateMany/);
assert.match(serviceSource, /version: document\.version/);
...
assert.doesNotMatch(transportSource, /createSupabaseBrowserClient/);
assert.doesNotMatch(transportSource, /cell-document-update/);
assert.doesNotMatch(transportSource, /supabase\.realtime\.setAuth/);
